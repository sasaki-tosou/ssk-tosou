              ...
              <div className="flex-wrap">
                <article className="main_b">
                  ...
                  <p className='center bold orange'>{data.microcmsBlog.category.name}</p>
                    ...
                    <p><span className='date'><time dateTime={dayjs.utc(data.microcmsBlog.date).tz('Asia/Tokyo').format('YYYY-MM-DDTHH:mm:ss')}>{dayjs.utc(data.microcmsBlog.date).tz('Asia/Tokyo').format('YYYY年MM月DD日')}</time></span></p>
