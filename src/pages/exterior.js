        ...
        <section id="sub-page">
            ...
            <div className="gaiheki_title_box">
                <h1>
                    ...
                    <StaticImage src="../images/exterior/exterior_img01_smp.png" alt="玄関ドア、窓リフォーム、フェンス取付け、外構工事 エクステリア工事" className="smp" />
                </h1>
            </div>
            ...
            <div className="exterior_content">
                ...
                <div className="flex-vcenter">
                    ...
                    <div className="cover_point_r order1 p2p"><StaticImage src="../images/exterior/default_img_01.png" alt="" /></div>
                </div>
                <div className="flex-vcenter">
                    ...
                    <div className="cover_point_r p2p"><StaticImage src="../images/exterior/default_img_02.png" alt="" /></div>
                </div>
                <div className="flex-vcenter">
                    <div className="cover_point_l order2 p2p">
                    ...
                    <div className="cover_point_r order1 p2p"><StaticImage src="../images/exterior/default_img_03.jpg" alt="" /></div>
                </div>
            </div>
            ...
            <div className="exterior_content">
                ...
                <div className="flex-vcenter">
                    ...
                    <div className="cover_point_r order1 p2p"><StaticImage src="../images/exterior/carport-st_img_01.jpg" alt="" /></div>
                </div>
                <div className="flex-vcenter">
                    <div className="cover_point_l p2p">
                    ...
                    <div className="cover_point_r p2p"><StaticImage src="../images/exterior/carport-st_img_02.jpg" alt="" /></div>
                </div>
                <div className="flex-vcenter">
                    <div className="cover_point_l order2 p2p">
                    ...
                    <div className="cover_point_r order1 p2p"><StaticImage src="../images/exterior/carport-st_img_03.jpg" alt="" /></div>
                </div>
            </div>
            ...
            <div className="exterior_content">
                ...
                <div className="flex-vcenter">
                    ...
                    <div className="cover_point_r order1 p2p"><StaticImage src="../images/exterior/speene_img_01.png" alt="" /></div>
                </div>
                <div className="flex-vcenter">
                    <div className="cover_point_l p2p">
                    ...
                    <div className="cover_point_r p2p"><StaticImage src="../images/exterior/speene_img_02.png" alt="" /></div>
                </div>
                <div className="flex-vcenter">
                    <div className="cover_point_l order2 p2p">
                    ...
                    <div className="cover_point_r order1 p2p"><StaticImage src="../images/exterior/speene_img_03.png" alt="" /></div>
                </div>
            </div>
            ...
            <div className="exterior_content">
                ...
                <div className="flex-vcenter">
                    ...
                    <div className="cover_point_r order1 p2p"><StaticImage src="../images/exterior/kirarastage_img_01.jpg" alt="" /></div>
                </div>
                <div className="flex-vcenter">
                    <div className="cover_point_l p2p">
                    ...
                    <div className="cover_point_r p2p"><StaticImage src="../images/exterior/kirarastage_img_02.jpg" alt="" /></div>
                </div>
                <div className="flex-vcenter">
                    <div className="cover_point_l order2 p2p">
                    ...
                    <div className="cover_point_r order1 p2p"><StaticImage src="../images/exterior/kirarastage_img_03.jpg" alt="" /></div>
                </div>
            </div>
            ...
            <div className="exterior_content">
                ...
                <div className="p2p">
                    <p className="center"><StaticImage src="../images/exterior/erumo_pic01.jpg" alt="" /></p>
                </div>
                <div className="exterior_title">
                ...
                <div className="p2p">
                    ...
                    <p><StaticImage src="../images/exterior/erumo_pic02.jpg" alt="" /></p>
                    <p><StaticImage src="../images/exterior/erumo_pic03.jpg" alt="" /></p>
                ...
                <div className="p2p">
                    ...
                    <p><StaticImage src="../images/exterior/erumo_pic04.jpg" alt="" /></p>
                </div>
                <div className="exterior_title">
                ...
                <div className="p2p">
                    <div className="flex-wrap">
                        <div className='w15p'><StaticImage src="../images/exterior/erumo_pic05.jpg" alt="" /></div>
                        <div className='w85p'>
                ...
                <div className="p2p">
                    ...
                    <p><StaticImage src="../images/exterior/erumo_pic06.jpg" alt="" /></p>
                </div>
                <div className="exterior_title">
                ...
                <div className="p2p">
                    ...
                    <p><StaticImage src="../images/exterior/erumo_pic07.jpg" alt="" /></p>
                </div>
                <div className="exterior_title">
                ...
                <div className="p2p">
                    ...
                    <p><StaticImage src="../images/exterior/erumo_pic08.jpg" alt="" /></p>
                </div>
                <div className="exterior_title">
                ...
                <div className="p2p">
                    ...
                    <p><StaticImage src="../images/exterior/erumo_pic09.jpg" alt="" /></p>
                </div>
                <div className="exterior_title">
                ...
                <div className="p2p">
                    <div className="flex-wrap">
                        <div className='w20p'><StaticImage src="../images/exterior/erumo_pic10.jpg" alt="" /></div>
                        <div className='w80p'>
