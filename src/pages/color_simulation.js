      ...
      <Layout>
        ...
        <section id="sub-page">
            ...
            <div className="color_catch_box">
                <div className="color_catch_img"><img src="../images/color_pic01.jpg" loading="lazy" alt="" /></div>
            ...
            <ul className="color_img_list">
                <li><img src="../images/color_pic02.jpg" loading="lazy" alt="" /></li>
                <li><img src="../images/color_pic03.jpg" loading="lazy" alt="" /></li>
                <li><img src="../images/color_pic04.jpg" loading="lazy" alt="" /></li>
                <li><img src="../images/color_pic05.jpg" loading="lazy" alt="" /></li>
            </ul>
            ...
            <div className="flex-wrap">
                ...
                <div className="w30p"><img src="../images/color_pic12.jpg" loading="lazy" alt="" /></div>
            </div>
