      ...
      <Layout>
        ...
        <section id="sub-page">
            ...
            <div className="color_catch_box">
                <div className="color_catch_img"><img src="../images/color_pic01.jpg" alt="" /></div>
            ...
            <ul className="color_img_list">
                <li><img src="../images/color_pic02.jpg" alt="" /></li>
                <li><img src="../images/color_pic03.jpg" alt="" /></li>
                <li><img src="../images/color_pic04.jpg" alt="" /></li>
                <li><img src="../images/color_pic05.jpg" alt="" /></li>
            </ul>
