        ...
        <section id="sub-page">
            <div className="main-content">
                ...
                <div className="flex-wrap">
                    <div className="w25p plr15p_smp"><img src="../images/boss_photo.png" loading="lazy" alt="" /></div>
                    <div className="w75p pl3p">
                        ...
                        <p className="right"><img src="../images/boss_sign.png" loading="lazy" alt="" /></p>
                    </div>
                </div>
                ...
                <div className="flex-wrap">
                    ...
                    <div className="w30p"><img src="../images/company_pic01.png" loading="lazy" alt="" /></div>
                </div>
