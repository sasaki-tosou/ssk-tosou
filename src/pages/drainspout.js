      ...
      <Layout>
        ...
        <section id="sub-page">
            ...
            <div className="gaiheki_title_box">
                <h1>
                    <img src="../images/drainspout/drainspout_img01.png" alt="雨樋の破損や詰まりは放っておかずに早目のお手入れを！ 雨樋の交換" className="pc" />
                    <img src="../images/drainspout/drainspout_img01_smp.png" alt="雨樋の破損や詰まりは放っておかずに早目のお手入れを！ 雨樋の交換" className="smp" />
                </h1>
            </div>
            ...
            <ul className='drainspout_img_list'>
                <li>留め金具の錆び<br />
                <img src="../images/drainspout/drainspout_pic01.jpg" loading="lazy" alt="" /></li>
                <li>雨樋の外れ<br />
                <img src="../images/drainspout/drainspout_pic02.jpg" loading="lazy" alt="" /></li>
                <li>軒樋の湾曲<br />
                <img src="../images/drainspout/drainspout_pic03.jpg" loading="lazy" alt="" /></li>
                <li>雨水の滞留<br />
                <img src="../images/drainspout/drainspout_pic04.jpg" loading="lazy" alt="" /></li>
                <li>ヘドロの堆積<br />
                <img src="../images/drainspout/drainspout_pic05.jpg" loading="lazy" alt="" /></li>
                <li>苔の繁殖<br />
                <img src="../images/drainspout/drainspout_pic06.jpg" loading="lazy" alt="" /></li>
            </ul>
            ...
            <ul className='drainspout_img_list2'>
                <li><img src="../images/drainspout/drainspout_pic07.jpg" loading="lazy" alt="" /></li>
                <li><img src="../images/drainspout/drainspout_pic08.jpg" loading="lazy" alt="" /></li>
            </ul>
            ...
            <div className="drainspout_content mt10p">
                ...
                <div className='flex-wrap'>
                    <div className="drainspout_osusume">
                        ...
                        <p><img src="../images/drainspout/drainspout_pic09.jpg" loading="lazy" alt="" /></p>
                    ...
                    <div className="drainspout_osusume">
                        ...
                        <p><img src="../images/drainspout/drainspout_pic10.jpg" loading="lazy" alt="" /></p>
                    ...
                    <div className="drainspout_osusume">
                        ...
                        <p><img src="../images/drainspout/drainspout_pic11.jpg" loading="lazy" alt="" /></p>
            ...
            <div className="drainspout_content">
                ...
                <div className='flex-wrap'>
                    <div className="drainspout_osusume">
                        <h3 className="noto_san bold orange txt160p mb3p">半丸105</h3>
                        <p><img src="../images/drainspout/drainspout_pic12.jpg" loading="lazy" alt="" /></p>
                        <p className='txt_r'>2,000円／ｍ～</p>
                        <p>和風住宅によく使用されます</p>
                    </div>
                    <div className="drainspout_osusume">
                        <h3 className="noto_san bold orange txt160p mb3p">角樋（Σ90）</h3>
                        <p><img src="../images/drainspout/drainspout_pic13.jpg" loading="lazy" alt="" /></p>
                    ...
                    <div className="drainspout_osusume">
                        <h3 className="noto_san bold orange txt160p mb3p">角樋（Ｈ120）</h3>
                        <p><img src="../images/drainspout/drainspout_pic14.jpg" loading="lazy" alt="" /></p>
            ...
            <div className="drainspout_content">
                ...
                <div className='flex-wrap'>
                    <div className="drainspout_osusume">
                        ...
                        <p><img src="../images/drainspout/drainspout_pic15.jpg" loading="lazy" alt="" /></p>
                        <p className='txt_r'>2,000円／ｍ～</p>
                        <p>和風住宅から洋風住宅まで幅広く使用されます</p>
                    </div>
                    <div className="drainspout_osusume">
                        <h3 className="noto_san bold orange txt160p mb3p">角樋</h3>
                        <p><img src="../images/drainspout/drainspout_pic16.jpg" loading="lazy" alt="" /></p>
                        <p className='txt_r'>2,000円／ｍ～</p>
                        <p>洋風住宅によく使用されます</p>
                    </div>                    
                </div>
            ...
            <ul className='drainspout_img_list'>
                <li><img src="../images/drainspout/drainspout_pic17.jpg" loading="lazy" alt="" /></li>
                <li><img src="../images/drainspout/drainspout_pic18.jpg" loading="lazy" alt="" /></li>
                <li><img src="../images/drainspout/drainspout_pic19.jpg" loading="lazy" alt="" /></li>
            </ul>
            ...
            <ul className='drainspout_img_list'>
                <li><img src="../images/drainspout/drainspout_pic20.jpg" loading="lazy" alt="" /></li>
            </ul>
            ...
            <div className="drainspout_content">
                ...
                <div className='p2p'>
                        ...
                        <p><img src="../images/drainspout/drainspout_pic21.jpg" width={380} loading="lazy" alt="" /></p>
                        <p>4,000円／ｍ～<br />
            ...
            <ul className='drainspout_img_list2'>
                <li><img src="../images/drainspout/drainspout_pic22.jpg" loading="lazy" alt="" /></li>
                <li><img src="../images/drainspout/drainspout_pic23.jpg" loading="lazy" alt="" /></li>
            </ul>
            ...
            <div className="drainspout_content">
                ...
                <div className="drainspout_osusume">                        
                    <p><img src="../images/drainspout/drainspout_pic24.jpg" loading="lazy" alt="" /></p>
                </div>                    
            ...
            <div className="drainspout_content">
                ...
                <div className='flex-wrap'>
                    <div className="drainspout_osusume">
                        ...
                        <p><img src="../images/drainspout/drainspout_pic25.jpg" loading="lazy" alt="" /></p>
                        <p>上屋根の軒先7.7ｍにスノーキング(小型)を取付けました。</p>
                    </div>
                    <div className="drainspout_osusume">
                        <h3 className="noto_san bold orange txt160p mb3p">ケース②</h3>
                        <p>屋根からの落雪で隣りの敷地に雪が落ちる（鋼板屋根　雪止めなし）</p>
                        <p><img src="../images/drainspout/drainspout_pic26.jpg" loading="lazy" alt="" /></p>
                        <p>上屋根の軒先5.5ｍにスノーキング(小型　ステンレス)を取付けました。</p>
                    </div>
                    <div className="drainspout_osusume">
                        <h3 className="noto_san bold orange txt160p mb3p">ケース③</h3>
                        <p>屋根からの落雪で１階のテラスの屋根材が破損してしまった（陶器平板瓦　雪止め金具有り）</p>
                        <p><img src="../images/drainspout/drainspout_pic27.jpg" loading="lazy" alt="" /></p>
