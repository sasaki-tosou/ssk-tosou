            ...
            <form action="https://ssgform.com/s/WLQ2NgMqEU46" method="post">
              ...
              <table className="form">
                <tbody>
                  ...
                  <tr>
                    <th>
                      都道府県<span className="must">必須</span>
                    </th>
                    <td>
                  ...
                  <tr>
                    <th>
                      ご希望のご返答方法<span className="must">必須</span>
                    </th>
                    <td>
                      <label>
                        <input
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <label>
                        <input type="radio" name="建物の種類" value="店舗" />{" "}
                        店舗
                      </label>
                      <label>
                        <input type="radio" name="建物の種類" value="その他" />{" "}
                        その他
                      </label>
                      <br />
                      <input
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <label>
                        <input type="radio" name="工事期間" value="１年以内" />{" "}
                        １年以内
                      </label>
                      <label>
                        <input type="radio" name="工事期間" value="未定" /> 未定
                      </label>
                    </td>
                  </tr>
                  <tr>
              ...
              <div
                ...
                data-sitekey="6Ldwz30kAAAAABVYDLLozQq6JFPgVUEuRYKGuJEy"
              ></div>
