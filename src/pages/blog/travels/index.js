      ...
      <Layout>
        ...
        <div id="breadcrumb">
          <ul class="breadcrumb__list" itemscope itemtype="https://schema.org/BreadcrumbList">
            ...
            <li class="breadcrumb__item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
              <Link to="/blog/travels/" itemprop="item">
          ...
          <div className='main-content'>
            ...
            <div className="flex-wrap">
              <div className="main_b">
                  ...
                  <p className='center bold orange'>旅行記</p>
                  ...
                  {data.allMicrocmsBlog.edges.map(({ node }) => (
                    <div className="kiji_box">
                      ...
                      <div className="kiji_txt">					
                        ...
                        <ul class="cat_list">
                          <li class="staffblog"><a href={'/blog/' + node.category.slug + '/'} class="txt12">{node.category.name}</a></li>
                        </ul>
                      </div>
                    </div>
                    ))}
...
{
  allMicrocmsBlog(
    filter: {category: {slug: {eq: "travels"}}}
    sort: {date: DESC}
    limit: 50
    ) {
    edges {
