    ...
    <>
      <footer>
            ...
            <div className="w70p">
              <div className="foot_link_box">
                ...
                <div className="foot_link">
                  ...
                  <ul>
                    <li>
                      <Link to="/gaiheki/">外壁塗装</Link>
                    </li>
                    <li>
                      <Link to="/yane/">屋根塗装</Link>
                    </li>
                    <li>
                      <Link to="/yanefuki/">屋根葺替え</Link>
                    </li>
                    <li>
                      <Link to="/yanecover/">屋根カバー工法</Link>
                    </li>
                    <li>
                      <Link to="/drainspout/">雨樋の交換</Link>
                    </li>
                    <li>
                      <Link to="/exterior/">エクステリア</Link>
                    </li>
                  </ul>
                </div>
                <div className="foot_link">
                ...
                <div className="foot_link">
                  ...
                  <ul>
                    <li>
                      <Link to="/#souba_check">最短10秒無料相場チェック</Link>
                    </li>
                    <li>
                      <Link to="/leak/">雨漏り無料診断</Link>
                    </li>
                    <li>
        ...
        <div className="address">
          <address>
            Copyright &copy; 株式会社佐々木塗装 All rights reserved.
          </address>
        </div>
      </footer>
    </>
