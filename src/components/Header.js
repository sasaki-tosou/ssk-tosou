                    ...
                    <div className="h_box">
                        ...
                        <div className="g_nav">
                            <ul>
                                ...
                                <li><Link to="/blog/arekore-blog/" className="are_img"><img src="/images/sasaki_icon.png" width={80} alt="アレコレブログ" /></Link></li>
                            </ul>
                        </div>
                        ...
                        <div id="overlay">
                            <div>
                                <ul className="gnav__menu">
                                    ...
                                    <li className="gnav__menu__item"><Link to="/blog/arekore-blog/">アレコレブログ</Link></li>
                                </ul>
                                <ul className="sns_bt">
