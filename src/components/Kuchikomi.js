      ...
      <section id="kuchikomi">
        <div className="main-content">
          ...
          <ul className="kuchikomi_box">
            ...
            対応が素晴らしく丁寧な会社です。会社の方で近所の方々へ挨拶までして貰いました。今回下手くそなトータテリフォームセンターでボコボコに壊された上にサポートすらして貰えなかった雨戸の戸板と雨戸の尻拭い工事で再々塗装をお願いしました。他社の失敗の尻拭い工事だったので塗装面積も少なく何だか申し訳無かったです。それでも親切に対応して貰いリーズナブルな価格で仕事を引き受けて頂き凄く有難かったです。佐々木塗装さんに工事を依頼する為に電話した時、亡き父親の事を良く知っていらしたので、それを知っていたら最初からこちらに頼んだのにと凄く後悔しております。名前が佐々木塗装さんなので塗装だけのイメージが有りますが基本的にリフォーム全般を扱っており、名前だけが有名で高額な設計料を払った上に手数料ばかり取り割高で下手な業者に依頼するより圧倒的に佐々木塗装さんの方が100倍良いです。亡き父親が生きていたら最初からこちらでリフォーム工事全般をお願いしていたと思います。とても良い会社で申し分の無い仕事だったので本当に勿体ない事をしました。</li>
            <li><span className="star">★★★★★</span> <span className="bold">2023/4/12 立山多輝久様</span><br />
            外壁の塗装をお願いしました。忖度なしに評価させてもらいます。一番最初に足場の入り口用に駐車場をつぶさないといけないと言われ、さすがに作業期間中ずっと他に車を置いておけるスペースもないので、別の場所に入り口を作ってもらいました。こちらから申し出なかったらそのままだったと思うと、そこは少しだけ残念。ただ、そこを差し引いても仕事は丁寧にしていただき、満足しております。毎朝きっちり同時刻に来て、作業をすすめられていました。一通り外壁塗装の作業が終わった後も、入念に確認し、雨樋やベランダやすのこも塗ってもらったりと、いろいろよくしてもらいました。ありがとうございました。</li>
            <li><span className="star">★★★★★</span> <span className="bold">2023/3/18 MASA K様</span><br />
            ...
            <li><span className="star">★★★★★</span> <span className="bold">2022/7/26 ネコずきS</span><br />
            社長さんはじめ社員の皆さん、職人さん皆さん爽やかで感じのいい方ばかりでこちらも毎日爽やかな気持ちで過ごせました。ありがとうございました。</li>
            ...
            <li><span className="star">★★★★★</span> <span className="bold">2022/5/20 中田由岐恵</span><br />
            外壁塗装をお願いしました。どんな色にするか迷いましたが、色見本を作っていただき気に入った色に塗装する事が出来ました。施工中も工事予定・進捗状況の説明があり、工事状況がよく分かりました。職人の方々に細かいところまで丁寧に仕事をしていただき、きれいになり気持ちいいです。ありがとうございました。残念なのは、外構の塗装色を慎重に決めなかった事です。</li>
            ...
            <li><span className="star">★★★★★</span> <span className="bold">2021/9/7 香様</span><br />
            ...
            <li><span className="star">★★★★★</span> <span className="bold">2021/6/16 yuji様</span><br />
            外壁塗装と玄関ドアの交換を依頼しました。 しっかりとした事前調査や見積書の提示があり、施工方法や塗料の種類など熱心に説明して頂きました。従業員の方はとても礼儀正しく、毎日コツコツ丁寧に頑張っておられ、熱心な仕事ぶりに感心いたしました。細かい部分までしっかり塗装されており、とても良い仕上がり具合に大変満足しております。 ありがとうございました。</li>
            <li><span className="star">★★★★★</span> <span className="bold">2021/5/16 平元裕太郎様</span></li>
            <li><span className="star">★★★★★</span> <span className="bold">2021/4/8 林裕美様</span><br />
            最初の打ち合わせから細かいところまでこちらの要望を聞き入れてもらいました。施工事例を見せてもらったり実際のお宅まで連れて行ってもらえたので安心してお任せできました。工事が始まってからもその都度確認してもらえるところもよかったです。色々アドバイスもしてもらえたのでたすかりました。最後の日には家の周りをきれいに掃除してもらえ工事前よりきれいになっていました。リモートワークをしている時間は音が出ないように配慮してもらい問題なく仕事ができました。ありがとうございました。</li>
            <li><span className="star">★★★★★</span> <span className="bold">2020/9/16 makoto ichibu様</span><br />
            外壁塗装と数箇所のリフォーム実施にあたり、佐々木塗装様には見積、工事内容の説明等、PCを駆使され詳しく説明していただきました。また、工事実施中は作業員様のその日の工事内容等詳細に作業日誌に記入提示していただき、安心することができました。大変ありがとうございました。思った以上に綺麗に完成し感謝しております。 この出会いに感謝します。 ありがとうございました(*^.^*)</li>
            <li><span className="star">★★★★★</span> <span className="bold">2021/12/8 GEK ZZR様</span><br />
            外壁塗装をお願いするなら「佐々木塗装」さまと以前から決めていました！ 社長と奥さまには何度も足を運んでいただき感謝しております。施工担当の方も良い人ばかりで共働きの我が家でも安心してお任せすることができました。 外壁の仕上がりはもちろんのこと、細かな配慮やサービスも含め、佐々木塗装さまに施工していただいてとても満足しております。 本当にありがとうございました。</li>
            <li><span className="star">★★★★★</span> <span className="bold">2020/5/15 ミヤモトユキコ様</span><br />
            屋根工事をお願いしました。これで、雨の日の不安がなくなり、仕事も丁寧で早く施工していただいたので大変満足しています。ありがとうございました。</li>
            <li><span className="star">★★★★★</span> <span className="bold">2020/5/20 見門勝様</span><br />
            出来上がりの外観が思った以上に素晴らしかった。新築のようになり感激しております。</li>
            <li><span className="star">★★★★★</span> <span className="bold">2020/7/8 高木秀人様</span><br />
            丁寧な工事と心づかいに満足している。</li>
            <li><span className="star">★★★★★</span> <span className="bold">2020/6/1 藤田範子様</span><br />
            職人さんが一から丁寧に仕事されていてとても好感が持てましたし、仕上がりにも大満足です。 色に迷った際も施工例や見本などしっかり顧客の要望を聞いた上で提案して下さり有り難かったです。 地域密着でアットホームな雰囲気なのでまた何かあったら是非お願いしたいです。</li>
            <li><span className="star">★★★★★</span> <span className="bold">2020/6/1 chika fukunaga様</span><br />
            とてもキレイに仕上がって、大満足です。 職人さんも、営業の方も、スタッフ全員感じが良く、挨拶もきちんとされご近所の方にも丁寧に作業されているね、とほめられました。ペイペイを使ってポイント還元もあり、とてもお得にキレイになり得した気分です(笑) 工期の間、気になる事があって連絡したら、直ぐに対応して下さったので安心も出来ました。 塗装の事で友達に相談されたら、佐々木塗装さんを絶対に薦めたいと思います！ ありがとうございました</li>
            <li><span className="star">★★★★★</span> <span className="bold">2020/5/6 matsuura masaki様</span><br />
            大変丁寧に対応していただき好感が持てました。 もちろん塗装の仕上がりにも満足しております。 次回もお願いしたいです。</li>
            <li><span className="star">★★★★★</span> <span className="bold">2020/4/20 Kaori Homma様</span><br />
            とても丁寧で満足の仕上がりでした。細やかな気配りをしていただき、信頼できる会社です。</li>
            <li><span className="star">★★★★★</span> <span className="bold">2020/4/8 三谷謙三様</span><br />
            近所の方にもキレイになったと言われ満足しております。</li>              
            <li><span className="star">★★★★★</span> <span className="bold">2020/3/28 Eared owl</span><br />
